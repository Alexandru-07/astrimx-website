...
const translations = {
  ro: {
    ...
    "plans.standard.feature2":
      "Sectiuni: Hero, Despre, Servicii, Contact",
    ...
    "plans.standard.feature7":
      "Construit cu HTML / CSS / JavaScript",
    "plans.standard.feature8":
      "Hosting si domeniu neincluse (ofer ghidaj)",
    ...
    "plans.plus.feature4":
      "Formular de contact (functionalitate de baza)",
    ...
    "plans.plus.feature10":
      "Ghidaj pentru hosting si domeniu inclus",
    ...
    "contact.card.subheading":
      "Anghel Alexandru &mdash; Programator &amp; CEO",
    ...
    "form.name.placeholder": "Cine semneaza mesajul?",
    "form.email.label": "Email",
    "form.email.placeholder": "tu@example.com",
    "form.message.label": "Detalii proiect",
    "form.message.placeholder":
      "Descrie site-ul, obiectivele si deadline-ul.",
    ...
    "github.network":
      "A aparut o problema de retea. Verifica conexiunea.",
  ...
  en: {
    ...
    "projects.skills.description":
      "Battle-tested tools for modern frontends.",
    "plans.heading": "Plans",
    "plans.description":
    ...
    "plans.standard.feature4":
      "Basic on-page SEO (title & meta description)",
    ...
    "plans.plus.feature1":
      "Up to 3 pages (Home, About, Services or similar)",
    "plans.plus.feature2":
      "Modern design with advanced sections",
    "plans.plus.feature3":
    ...
    "plans.premium.feature5":
      "Portfolio/Gallery page included",
    "plans.premium.feature6":
    ...
    "plans.premium.feature9":
      "Anti-spam form protection (honeypot)",
    ...
    "contact.card.subheading":
      "Anghel Alexandru &mdash; Programmer &amp; CEO",
    ...
    "form.name.placeholder": "Who should I thank?",
    "form.email.label": "Email",
    "form.email.placeholder": "you@example.com",
    "form.message.label": "Project Notes",
    "form.message.placeholder":
      "Describe your site, goals, and deadline.",
    "form.submit": "Send Message",
    "footer.credit": "AstrimX &middot; Crafted by Anghel Alexandru",
    "github.loading":
      "Loading GitHub data for @Alexandru-07...",
    "github.unavailable":
      "GitHub profile unavailable at the moment.",
    "github.fetching": "Fetching profile data...",
    "github.notFound":
      "No profile found with that username. Check spelling.",
    "github.serviceDown":
      "GitHub is unavailable right now. Try again shortly.",
    "github.network":
      "Network issue detected. Please verify your connection.",
...
const applyTranslations = (lang) => {
  ...
  attributeElements.forEach((element) => {
    ...
    rawInstructions.split("|").forEach((instruction) => {
      ...
      const attrKey =
        (keyRaw && keyRaw.trim()) || element.dataset.i18n || "";
...
const setGithubMessage = (messageKey) => {
  ...
  githubRepoData = [];
  githubResult.innerHTML = `<p class="muted-text">${translate(
    messageKey
  )}</p>`;
};
